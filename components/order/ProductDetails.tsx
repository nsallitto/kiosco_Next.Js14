...
export default function ProductDetails({ item }: ProductDetailsProps) {
    ...
    return (
        <div className="bg-white border-t border-gray-200 p-4 shadow space-y-1">
            <div className="space-y-4">
                ...
                <p className="text-2xl text-amber-400 font-black">
                    {formatCurrency(item.price)}
                </p>
                <div className="flex gap-5 px-6 py-2 bg-gray-100 w-fit rounded-lg">
